...
I defined the human's ability to read images as a policy of reinforcement learning, and an agent's prediction of this as an action. I also considered inverse reinforcement learning and GAIL. But, in this case, the reward function is pretty clear and the policy is more mportant,I descided to use PPO that also does not need the MDP(Markov Decision Process).
